...
/*   Updated: 2021/07/11 15:35:20 by cpereira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	add_samples(t_v *v)
{
	...
	add_hist(v, "echo cezar | sed \"s/cezar/paulo/\"");
	add_hist(v, "echo daniel | sed \"s/cezar/paulo/\"");
	add_hist(v, "echo \"cezar | paulo \"");
	add_hist(v, "echo \"cezar > paulo \"");
	...
	add_hist(v, "echo cezar | sed \"s/cezar/paulo/\" | sed \"s/paulo/42/\"");
	add_hist(v, "echo $cezar");
	add_hist(v, "echo $cez");
	add_hist(v, "export cezar=paulo");
}
